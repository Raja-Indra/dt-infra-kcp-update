...
$error = '';
$success = '';
if(isset($_GET['added'])) $success = "Asset berhasil ditambahkan.";
if(isset($_GET['updated'])) $success = "Asset berhasil diperbarui.";
if(isset($_GET['deleted'])) $success = "Asset berhasil dihapus.";
...
$sql_total = "
    ...
    FROM attendance a
    LEFT JOIN merk_asset m ON a.merk_id = m.id
    LEFT JOIN type_asset t ON a.type_id = t.id
    $where_sql
";
...
$sql = "
    SELECT a.*, m.merk_name, t.type_name
    FROM attendance a
    LEFT JOIN merk_asset m ON a.merk_id = m.id
    LEFT JOIN type_asset t ON a.type_id = t.id
    $where_sql
...
// Get merk list
$merk_list = mysqli_query($conn,"SELECT id, merk_name FROM merk_asset WHERE category='Attendance' ORDER BY merk_name");
...
<div class="container-fluid mt-4">
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
            <h2 class="h5 mb-0">Attendance Assets</h2>
        </div>
        <div class="card-body">
                ...
                <div class="row g-2 align-items-end">
                    <div class="col-md-3">
                        ...
                        <select name="model" id="model" class="form-select form-select-sm">
                            ...
                            <?php foreach(['Finger Print','Face Capture'] as $c): ?>
                    ...
                    <div class="col-auto">
                        <a href="attendance.php" class="btn btn-outline-secondary btn-sm">Reset</a>
                    </div>
                    <div class="col-auto">
                        <a href="attendance_input.php" class="btn btn-success btn-sm">+ Input Asset</a>
                    </div>
                </div>
            </form>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                ...
                                ?>
                                <a href="attendance_input.php?<?= $link_params ?>" class="btn btn-primary btn-sm">Edit</a> 
                                <a href="attendance_delete.php?<?= $delete_params ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this asset?')">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                    </tbody>
