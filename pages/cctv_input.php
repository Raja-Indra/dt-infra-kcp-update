...
if($id){
    ...
    $stmt = $conn->prepare("SELECT * FROM cctv WHERE id = ?");
...
// Merk list kategori CCTV
$merk_list = mysqli_query($conn, "SELECT * FROM merk_asset WHERE category='CCTV' ORDER BY merk_name");
...
<html>
<head>
    <title><?= $id ? 'Edit' : 'Input' ?> CCTV Asset</title>
        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h2 class="h5 mb-0"><?= $id ? 'Edit' : 'Input' ?> CCTV Asset</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="cctv_process.php">
                        <?php if($id): ?>
                        ...
                        <div class="mt-4 border-top pt-3 d-flex gap-2">
                            ...
                            ?>
                            <a href="cctv.php?<?= $cancel_query ?>" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
