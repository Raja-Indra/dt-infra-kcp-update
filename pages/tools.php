...
$error = '';
$success = '';
if(isset($_GET['added'])) $success = "Tool asset berhasil ditambahkan.";
if(isset($_GET['updated'])) $success = "Tool asset berhasil diperbarui.";
if(isset($_GET['deleted'])) $success = "Tool asset berhasil dihapus.";
...
$sql_total = "SELECT COUNT(*) as total FROM tools $where_sql";
...
$sql = "SELECT * FROM tools $where_sql ORDER BY id DESC LIMIT ? OFFSET ?";
$params[] = $limit;
$params[] = $offset;
$types .= "ii"; 
...
<div class="container-fluid mt-4">
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
            <h2 class="h5 mb-0">Tools Assets</h2>
        </div>
        <div class="card-body">
            ...
            <form method="GET" class="mb-3 border-bottom pb-3">
                <div class="row g-2 align-items-end">
                    <div class="col-md-3">
                        <label for="merk" class="form-label">Filter Merk</label>
                        <input type="text" name="merk" id="merk" class="form-control form-control-sm" value="<?= htmlspecialchars($merk) ?>">
                    </div>
                    <div class="col-auto">
                        <button type="submit" class="btn btn-primary btn-sm">Filter</button>
                    </div>
                    <div class="col-auto">
                        <a href="tools.php" class="btn btn-outline-secondary btn-sm">Reset</a>
                    </div>
                    <div class="col-auto">
                        <a href="tools_input.php" class="btn btn-success btn-sm">+ Input Asset</a>
                    </div>
                </div>
            </form>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                ...
                                ?>
                                <a href="tools_input.php?<?= $link_params ?>" class="btn btn-primary btn-sm">Edit</a>
                                <a href="tools_delete.php?<?= $delete_params ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this asset?')">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                    </tbody>
