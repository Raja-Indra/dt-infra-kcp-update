...
$error = '';
$success = '';
if (isset($_GET['added'])) $success = "Network asset berhasil ditambahkan.";
if (isset($_GET['updated'])) $success = "Network asset berhasil diperbarui.";
if (isset($_GET['deleted'])) $success = "Network asset berhasil dihapus.";
...
$sql_total = "
    ...
    FROM network n
    LEFT JOIN merk_asset m ON n.merk_id = m.id
    LEFT JOIN type_asset t ON n.type_id = t.id
    $where_sql
";
...
$sql = "
    SELECT n.*, m.merk_name, t.type_name
    FROM network n
    LEFT JOIN merk_asset m ON n.merk_id = m.id
    LEFT JOIN type_asset t ON n.type_id = t.id
    $where_sql
...
// Get merk list for filter
$merk_list = mysqli_query($conn,"SELECT id, merk_name FROM merk_asset WHERE category='Network' ORDER BY merk_name");
...
<div class="container-fluid mt-4">
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
            <h2 class="h5 mb-0">Network Assets</h2>
        </div>
        <div class="card-body">
                ...
                <div class="row g-2 align-items-end">
                    <div class="col-md-3">
                        ...
                        <select name="category" id="category" class="form-select form-select-sm">
                            ...
                            <?php foreach(['Router','Switch','Wireless'] as $c): ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="merk" id="merk" class="form-select form-select-sm">
                            <option value="">All</option>
                            <?php mysqli_data_seek($merk_list, 0); while($m=mysqli_fetch_assoc($merk_list)): ?>
                    ...
                    <div class="col-auto">
                        <a href="network.php" class="btn btn-outline-secondary btn-sm">Reset</a>
                    </div>
                    <div class="col-auto">
                        <a href="network_input.php" class="btn btn-success btn-sm">+ Input Asset</a>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                ...
                                ?>
                                <a href="network_input.php?<?= $link_params ?>" class="btn btn-primary btn-sm">Edit</a>
                                <a href="network_delete.php?<?= $delete_params ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this asset?')">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                    </tbody>
