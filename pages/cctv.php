...
$error = '';
$success = '';
if(isset($_GET['added'])) $success = "CCTV asset berhasil ditambahkan.";
if(isset($_GET['updated'])) $success = "CCTV asset berhasil diperbarui.";
if(isset($_GET['deleted'])) $success = "CCTV asset berhasil dihapus.";
...
// Get merk list
$merk_list = mysqli_query($conn,"SELECT id, merk_name FROM merk_asset WHERE category='CCTV' ORDER BY merk_name");
...
<div class="container-fluid mt-4">
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
            <h2 class="h5 mb-0">CCTV Assets</h2>
        </div>
        <div class="card-body">
                ...
                <div class="row g-2 align-items-end">
                    <div class="col-md-3">
                        ...
                        <select name="model" id="model" class="form-select form-select-sm">
                            ...
                            <?php foreach(['FIXED','PTZ','NVR'] as $c): ?>
                    ...
                    <div class="col-auto">
                        <a href="cctv.php" class="btn btn-outline-secondary btn-sm">Reset</a>
                    </div>
                    <div class="col-auto">
                        <a href="cctv_input.php" class="btn btn-success btn-sm">+ Input Asset</a>
                    </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                ...
                                ?>
                                <a href="cctv_input.php?<?= $link_params ?>" class="btn btn-primary btn-sm">Edit</a> 
                                <a href="cctv_delete.php?<?= $delete_params ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this asset?')">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                    </tbody>
